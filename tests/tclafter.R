...
tclafter        <- SlideDesignerGUI:::tclafter
tclafter.cancel <- SlideDesignerGUI:::tclafter.cancel
tclafter.idle   <- SlideDesignerGUI:::tclafter.idle
tclafter.info   <- SlideDesignerGUI:::tclafter.info
