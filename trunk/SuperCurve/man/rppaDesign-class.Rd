...
\usage{
RPPADesign(raw, steps = rep(0, 1), series = factor(rep(0, 1)),
...
seriesNames(design)
getSteps(design)
\S4method{image}{RPPADesign}(x, ...)
\S4method{summary}{RPPADesign}(object, ...)
...
\section{Methods}{
  \describe{
    \item{image(x, ...)}{The \code{image} method produces a
two-dimensional graphicla display of the layout design.  Colors are used
...
te deisgn has been specified correctly.}
    \item{summary(object, ...)}{The \code{summary} method lists the
names of the control spots on the array and then prints a summary of the
data fame describing the layout.}
    \item{names(x)}{The \code{names} method returns a chcracter vector
containing, for each non-control spot, the name of the dilutoin series
