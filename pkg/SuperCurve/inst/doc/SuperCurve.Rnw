...
%\VignetteDepends{methods, stats, utils, graphics, grDevices, MASS, cobs, mgcv}
...
<<getStarted02>>=
filename <- "Akt.txt";
directory <- system.file("extdata", "rppaCellData", package="SuperCurve");
...
filename <- "Akt.txt";
directory <- system.file("extdata", "rppaCellData", package="SuperCurve");
aktTake3 <- RPPA(file=filename, path=directory, software="user");
